...
IOM_micro <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/IOM Data Extract - 10.12.22.xlsx")
...
DSX_Forecast_Backup <- read_excel(
  "S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/DSX Forecast Backup - 2022.10.12.xlsx")
...
Open_Cust_Ord <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/wo receipt custord po - 10.12.22.xlsx", 
...
canada_micro <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Canada open order - 10.12.22.xlsx", 
                           col_names = FALSE)
...
jde_bom <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/JDE BoM 10.12.22.xlsx", 
                      col_names = FALSE)
...
FG <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inventory Report for all locations - 10.12.22.xlsx", 
                 col_names = FALSE,
                 sheet = "FG")
...
RM <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inventory Report for all locations - 10.12.22.xlsx", 
                 col_names = FALSE,
                 sheet = "RM")
