...
inventory_model <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/Desktop/SS Optimization by Location - Finished Goods February 2023.xlsx",
...
IOM_micro <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/IOM Data Extract - 02.01.23.xlsx")
...
DSX_Forecast_Backup <- read_excel(
  "S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/DSX Forecast Backup - 2023.02.07.xlsx")
...
Open_Cust_Ord <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/wo receipt custord po - 02.08.23.xlsx", 
...
canada_micro <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Canada open order - 02.08.23.xlsx", 
                           col_names = FALSE)
...
jde_bom <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/JDE BoM 02.08.23.xlsx", 
                      col_names = FALSE)
...
FG <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inventory Report for all locations - 02.08.23.xlsx", 
                 col_names = FALSE,
                 sheet = "FG")
...
RM <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inventory Report for all locations - 02.08.23.xlsx", 
                 col_names = FALSE,
                 sheet = "RM")
...
exception_report <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/exception report 02.08.23.xlsx")
