...
IOM_micro <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/2024/09.12.2024/IOM Data Extract.xlsx")
...
exception_report <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/09.12.2024/exception report.xlsx")
...
DSX_Forecast_Backup <- read_excel(
  "S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/BI Forecast Backup/2024/DSX Forecast Backup - 2024.09.12.xlsx")
...
Open_Cust_Ord <- read.xlsx("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/09.12.2024/US and CAN OO BT where status _ J.xlsx",
                           colNames = FALSE)
...
canada_micro <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/2024/09.12.2024/Canada Open Orders.xlsx", 
                           col_names = FALSE)
...
jde_bom_us <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/2024/09.12.2024/jde_us.xlsx", 
                         col_names = FALSE)
...
jde_bom_canada <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/2024/09.12.2024/jde_canada.xlsx", 
                             col_names = FALSE)
...
inventory_micro_rm <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/09.12.2024/Inventory.xlsx",
                                 sheet = "RM")
...
inventory_micro_fg <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/09.12.2024/Inventory.xlsx",
                                 sheet = "FG")
...
jde_inv_for_25_55_label <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/09.12.2024/JDE 25,55.xlsx")
...
# Category & Platform
completed_sku_list <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/09.12.2024/Completed SKU list - Linda.xlsx")
...
# Net Wt code update
pre_bom <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/2024/09.03.2024/Bill of Material_090324.xlsx")
...
find_destination_supplier <- function(comp_ref, exception_report_supplier) {
  ...
  cat("Processing comp_ref:", comp_ref, "\n")
  
  while (TRUE) {
    if (current_loc %in% visited_locs) {
      cat("Cycle detected at loc:", current_loc, "\n")
      return(NA)
    }
    ...
    if (nrow(current_row) == 0) {
      cat("No row found for loc:", current_loc, "and item:", item, "\n")
      return(NA)
    }
    ...
    cat("Current loc:", current_loc, "mpf_or_line:", mpf_or_line, "supplier:", supplier, "\n")
...
writexl::write_xlsx(jde_bom, "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/2024/09.12.2024/Bill of Material_091224.xlsx")


file.copy("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/2024/09.03.2024/JDE BoM 09.03.2024.xlsx", 
          "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/2024/09.12.2024/JDE BoM 09.12.2024.xlsx")
...
file.copy("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/2024/09.12.2024/JDE BoM 09.12.2024.xlsx", 
          "S:/Supply Chain Projects/Data Source (SCE)/JDE BoM/2024/JDE BoM 09.12.2024.xlsx", overwrite = TRUE)
