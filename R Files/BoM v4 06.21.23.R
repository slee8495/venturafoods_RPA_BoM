...
## FG_ref_to_mpg_ref added to repush 
...
category_bi <- read_excel("S:/Supply Chain Projects/Linda Liang/reference files/BI Category and Platform and pack size.xlsx")
...
inventory_model_data <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/Desktop/SS Optimization by Location - Finished Goods June 2023.xlsx",
...
IOM_micro <- read_excel("S:/Supply Chain Projects/Linda Liang/reference files/IOM Data Extract - 04.03.23.xlsx")
...
DSX_Forecast_Backup <- read_excel(
  "S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/DSX Forecast Backup - 2023.06.21.xlsx")
...
canada_micro <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Canada Open Order - 06.21.23.xlsx", 
                           col_names = FALSE)
...
jde_bom_us <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/JDE BoM US 06.21.23.xlsx", 
                         col_names = FALSE)
...
jde_bom_canada <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/JDE BoM Canada 06.21.23.xlsx", 
                             col_names = FALSE)
...
rio::convert("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/EF846505.csv",
             "C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/as400_86.xlsx")

as400_86 <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/as400_86.xlsx")
...
FG <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inventory Report for all locations FG - 06.21.23.xlsx", 
                 col_names = FALSE)
...
FG_2 <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inventory Analysis - 06.21.23.xlsx")
FG_2[-1, ] -> FG_2
...
RM <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Inventory Report for all locations RM - 06.21.23.xlsx", 
                 col_names = FALSE)
...
exception_report <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/exception report 06.21.23.xlsx")
...
# Category & Platform
completed_sku_list <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Completed SKU list - Linda.xlsx")
...
# Net Wt code update
pre_bom <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Bill of Material_061423.xlsx")
...
writexl::write_xlsx(jde_bom, "Bill of Material_062123.xlsx")



file.rename(from="C:/Users/slee/OneDrive - Ventura Foods/Stan/R Codes/Projects/BoM/venturafoods_RPA_BoM/Bill of Material_061423.xlsx",
            to="C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/6.14.2023/Bill of Material_061423.xlsx")
