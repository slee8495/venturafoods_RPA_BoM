...
category_bi <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/Source Data/Category and Platform and pack size - 07.27.22.xlsx")
...
IOM_micro <- read_excel("S:/Supply Chain Projects/Linda Liang/reference files/IOM Data Extract.xlsx")
...
exception_report <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/JDE Exception report extract/2024/exception report 2024.04.16.xlsx")
...
DSX_Forecast_Backup <- read_excel(
  "S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/BI Forecast Backup/2024/DSX Forecast Backup - 2024.04.15.xlsx")
...
Open_Cust_Ord <- read.xlsx("S:/Supply Chain Projects/Linda Liang/reference files/US and CAN OO BT where status _ J.xlsx",
                           colNames = FALSE)
...
canada_micro <- read_excel("S:/Supply Chain Projects/Linda Liang/reference files/Canada Open Orders.xlsx", 
                           col_names = FALSE)
...
jde_bom_us <- read_excel("S:/Supply Chain Projects/Linda Liang/reference files/jde_us.xlsx", 
                         col_names = FALSE)
...
jde_bom_us %>% 
  janitor::clean_names()%>%
  dplyr::rename(Business_Unit=business_unit,
...
jde_bom_canada <- read_excel("S:/Supply Chain Projects/Linda Liang/reference files/jde_canada.xlsx", 
                             col_names = FALSE)
...
inventory_micro_rm <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Inventory/Inventory with Lot Report v.2 - 2024.04.16.xlsx",
                                 sheet = "RM")
...
jde_inv_for_25_55_label <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Inventory/JDE Inventory Lot Detail - 2024.04.16.xlsx")
...
# tidy the numbers
jde_bom %>% 
  dplyr::rename(Unit_Cost=unit_cost)%>%
...
# Category & Platform
completed_sku_list <- read_excel("S:/Supply Chain Projects/Linda Liang/reference files/MSTR Category and Platform and pack size.xlsx")
...
# Net Wt code update
pre_bom <- read_excel("C:/Users/lliang/OneDrive - Ventura Foods/R Studio/BOM/raw files with JDE BOM report/Bill of Material_040924.xlsx")
...
writexl::write_xlsx(jde_bom, "C:/Users/lliang/OneDrive - Ventura Foods/R Studio/BOM/Bill of Material_041624.xlsx")
