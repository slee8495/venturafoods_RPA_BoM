...
inventory_model_data <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2023/6.12.23/SS Optimization by Location - Finished Goods June 2023.xlsx",
...
IOM_micro <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/6.28.2023/IOM Data Extract (17).xlsx")
...
DSX_Forecast_Backup <- read_excel(
  "S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/DSX Forecast Backup - 2023.06.28.xlsx")
...
canada_micro <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/6.28.2023/Canada Open Orders (12).xlsx", 
                           col_names = FALSE)
...
jde_bom_us <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/6.28.2023/jde_us.xlsx", 
                         col_names = FALSE)
...
jde_bom_canada <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/6.28.2023/jde_canada.xlsx", 
                             col_names = FALSE)
...
rio::convert("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/6.28.2023/EF869708.csv",
             "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/6.28.2023/as400_86.xlsx")

as400_86 <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/6.28.2023/as400_86.xlsx")
...
FG <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/6.28.2023/Inventory Report for all locations (26).xlsx", 
                 col_names = FALSE)
...
# Read Inventory Analysis Data add Loc 252 ----
FG_2 <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/6.28.2023/Inventory Analysis (94).xlsx")
FG_2[-1, ] -> FG_2
colnames(FG_2) <- FG_2[1, ]
FG_2[-1, ] -> FG_2

FG_2 %>% 
  janitor::clean_names() %>% 
  dplyr::filter(location == 252) %>% 
  dplyr::select(location, location_nm, curr_mfg_location, sku, description, inventory_status, inventory_hold_status, inventory_qty_cases) -> FG_2

colnames(FG_2)[1] <- "Location"
colnames(FG_2)[2] <- "Location_Name"
colnames(FG_2)[3] <- "Mfg_Location_campus"
colnames(FG_2)[4] <- "Item"
colnames(FG_2)[5] <- "Description"
colnames(FG_2)[6] <- "Inventory_Status_Code"
colnames(FG_2)[7] <- "Hold_Status"
colnames(FG_2)[8] <- "Current_Inventory_Balance"

rbind(FG, FG_2) -> FG

# (Path revision needed) Inventory from MicroStrategy (RM) ----

RM <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/6.28.2023/Inventory Report for all locations (27).xlsx", 
                 col_names = FALSE)
...
exception_report <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/6.28.2023/exception report.xlsx")
...
# Category & Platform
completed_sku_list <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/6.28.2023/Completed SKU list - Linda (16).xlsx")
...
# Net Wt code update
pre_bom <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/6.14.2023/Bill of Material_061423.xlsx")
...
writexl::write_xlsx(jde_bom, "Bill of Material_062823.xlsx")



file.rename(from="C:/Users/slee/OneDrive - Ventura Foods/Stan/R Codes/Projects/BoM/venturafoods_RPA_BoM/Bill of Material_062823.xlsx",
            to="C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/6.28.2023/Bill of Material_062823.xlsx")
