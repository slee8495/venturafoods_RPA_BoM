...
FG_On_Hand_Raw <- read_excel("C:/Users/SLee/OneDrive - Ventura Foods/Desktop/Inventory Analysis 03.18.22.xlsx", 
...
RM_On_Hand_Raw <- read_excel("C:/Users/SLee/OneDrive - Ventura Foods/Desktop/Inventory Analysis 03.18.22.xlsx", 
...
#   "S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/DSX Forecast Backup - 2022.03.17.xlsx")
# 
...
# Open_Cust_Ord <- read_excel("C:/Users/SLee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/custord.xlsx", 
...
#   dplyr::rename(temp_Loc = "2") -> Open_Cust_Ord
# 
...
# 
# Open_Cust_Ord %>% 
#   dplyr::bind_cols(remove_zero_1) %>% 
#   dplyr::select(-temp_Loc) %>% 
...
#   dplyr::relocate(ref, ProductSkuCode, Loc, Qty, date, year, month, day, month_year) -> Open_Cust_Ord
# 
...
writexl::write_xlsx(as400_7499,
                    path = "C:/Users/SLee/OneDrive - Ventura Foods/Desktop/BoM_Report_3.18.2022.xlsx")
