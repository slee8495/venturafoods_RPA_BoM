...
complete_sku_list <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/12172024/Complete SKU list - Linda.xlsx")
...
IOM_micro <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/12172024/IOM Data Extract.xlsx")
...
exception_report <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/JDE Exception report extract/2024/exception report 2024.12.17.xlsx")
...
DSX_Forecast_Backup <- read_excel(
  "S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/BI Forecast Backup/2024/DSX Forecast Backup - 2024.12.11.xlsx")
...
Open_Cust_Ord <- read.xlsx("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/12172024/US and CAN OO BT where status _ J.xlsx",
                           colNames = FALSE)
...
canada_micro <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/12172024/Canada Open Orders.xlsx", 
                           col_names = FALSE)
...
jde_bom_us <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/12172024/jde_us.xlsx", 
                         col_names = FALSE)
...
jde_bom_canada <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/12172024/jde_canada.xlsx", 
                             col_names = FALSE)
...
inventory_micro_rm <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Inventory/Inventory with Lot Report v.2 - 2024.12.17.xlsx",
                                 sheet = "RM")
...
inventory_micro_fg <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Inventory/Inventory with Lot Report v.2 - 2024.12.17.xlsx",
                                 sheet = "FG")
...
jde_inv_for_25_55_label <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Inventory/JDE Inventory Lot Detail - 2024.12.17.xlsx")
...
# Category & Platform
completed_sku_list <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/12172024/Complete SKU list - Linda.xlsx")
...
# Net Wt code update
pre_bom <- read_excel("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/12102024/Bill of Material_12102024.xlsx")
...
writexl::write_xlsx(jde_bom, "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/2024/12.17.2024/Bill of Material_12172024.xlsx")
...
file.copy("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/2024/12.10.2024/JDE BoM 12.10.2024.xlsx", 
          "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/2024/12.17.2024/JDE BoM 12.17.2024.xlsx")
...
file.copy("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/2024/12.17.2024/JDE BoM 12.17.2024.xlsx", 
          "S:/Supply Chain Projects/Data Source (SCE)/JDE BoM/2024/JDE BoM 12.17.2024.xlsx", overwrite = TRUE)
