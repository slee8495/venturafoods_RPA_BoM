...
as400_7499 <- read_excel("C:/Users/SLee/OneDrive - Ventura Foods/Desktop/Book2.xlsx", 
...
FG_On_Hand <- read_excel("C:/Users/SLee/OneDrive - Ventura Foods/Desktop/FG_On_Hand.xlsx", 
...
RM_On_Hand <- read_excel("C:/Users/SLee/OneDrive - Ventura Foods/Desktop/RM_On_Hand.xlsx", 
                         col_types = c("numeric", "numeric", "text", 
                                       "numeric", "numeric", "numeric", 
...
Open_Cust_Ord <- read_excel("C:/Users/SLee/OneDrive - Ventura Foods/Desktop/wo receipt custord po - 02.09.22.xlsx", 
...
writexl::write_xlsx(Open_Cust_Ord, "test.xlsx")
...
Open_Cust_Ord %>% 
  dplyr::mutate(next_30_days = ifelse(date < Sys.Date() + 16, "Y", "N")) -> Open_Cust_Ord
