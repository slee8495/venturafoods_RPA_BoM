...
category_bi <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/test 2 8.30.22/BI Category and Platform and pack size.xlsx")
...
IOM_micro <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/test 2 8.30.22/IOM Data Extract - 08.29.22.xlsx")
...
Open_Cust_Ord <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/test 2 8.30.22/wo receipt custord po - 08.29.22.xlsx", 
...
canada_micro <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/test 2 8.30.22/Canada open order - 08.29.22.xlsx", 
                           col_names = FALSE)
...
jde_bom <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/test 2 8.30.22/JDE BoM 08.29.22.xlsx", 
                      col_names = FALSE)
...
as400_86 <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/test 2 8.30.22/AS400 loc 86 BoM.xlsx", 
                       col_names = FALSE)
...
FG <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/test 2 8.30.22/Inventory Report for all locations - 08.29.22.xlsx", 
                 col_names = FALSE,
                 sheet = "FG")
...
RM <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/test 2 8.30.22/Inventory Report for all locations - 08.29.22.xlsx", 
                 col_names = FALSE,
                 sheet = "RM")
...
exception_report <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/test 2 8.30.22/exception report 08.29.22.xlsx")
...
writexl::write_xlsx(jde_bom, "bom_test_for_iqr_rm.xlsx")
...
writexl::write_xlsx(jde_bom, "Bill of Material 08.29.22.xlsx")
